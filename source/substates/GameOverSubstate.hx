...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public function new(?playStateBoyfriend:Character = null, camX:Float, camY:Float, zzoom:Float)
	{
	...
	override function create()
	{
		...
		FlxTween.tween(FlxG.camera, {zoom: 0.9, x: boyfriend.getGraphicMidpoint().x + boyfriend.cameraPosition[0], y: boyfriend.getGraphicMidpoint().y + boyfriend.cameraPosition[1]}, 0.5, {ease: FlxEase.cubeInOut});
	...
	function endBullshit():Void
	{
		if (!isEnding)
		{
			...
			{
				FlxTween.tween(boyfriend, {alpha: 0}, 2);
