...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	[
		...
		['Black Flash', "Value 1: speed\nValue 2: color"],
		['Change Cam Prop', "Value 1: dad or bf, then a coma, then the property name\nValue 2: value to set that property to\nEx: Value1: dad,ease Value2: FlxEase.quadOut\nProp Names:\nspeed,ease,bumpMult,angleMult\ndirMult,zoom,zSpeed,zEase,zLimit"]
	];
